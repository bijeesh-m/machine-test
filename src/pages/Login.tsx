...
const Login = () => {
    ...
    return (
        <div className=" w-screen h-screen bg-white flex justify-center items-center">
            ...
            >
                <h1 className=" text-2xl text-center mb-10 font-bold text-white">Login</h1>
                ...
                <p className=" flex gap-3 text-white">Don't have an account ? <Link className=" text-black underline" to={'/register'}>Register</Link></p>
